...
$server = "10.0.0.31"; // nama server yang temen-temen gunain. Ini default value kalau pake XAMPP.
$username = "admin";
$password = "Admin1,02/okt,21"; // sesuaikan dengan pasaword temen-temen :)
